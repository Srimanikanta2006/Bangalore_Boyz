import { isAllowedActionPriority, isValidAction } from "./actionCatalog";
import type {
  ActionDependency,
  AffectedAsset,
  AssetType,
...
/**
 * Runtime validation for the AI layer. TypeScript interfaces vanish at runtime,
 * so every untrusted boundary (model output, external request) is validated here
 * before it reaches application logic or the operator UI.
 */
