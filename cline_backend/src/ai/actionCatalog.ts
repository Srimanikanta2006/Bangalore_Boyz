...
/**
 * Controlled immediate/emergency action catalog. The AI may ONLY recommend
 * action IDs from this list, and only at their allowed priorities. This is the
 * safety boundary: the AI never invents arbitrary real-world actions.
 */
