...
/**
 * Deterministic fallback explanation. If Gemini is unavailable (missing key,
 * timeout, invalid JSON, failed validation) this produces a safe, grounded
 * explanation from the SAME verified facts. AI is an enhancement, never a
