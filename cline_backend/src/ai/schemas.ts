/**
 * P4 AI-layer contracts (ClimateShield).
 *
 * These are the AI-facing shapes. They are deliberately DECOUPLED from the
 * Prisma/domain types so the deterministic engine remains the source of truth
 * and the AI only ever receives already-verified facts (see ai/explainAdapter.ts).
 */
